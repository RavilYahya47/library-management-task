...
public class BookDAOImpl implements BookDAO {
    ...
    public Book save(Book book) throws SQLException {
        String sql = "INSERT INTO books (title, authorId, publicationYear, genre, pages, isAvailable, createdAt) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public void update(Book book) throws SQLException {
        String sql = "UPDATE books SET title = ?, authorId = ?, publicationYear = ?, genre = ?, pages = ?, "
                + "isAvailable = ?, createdAt = ? WHERE id = ?";
    ...
    private Book mapResultSetToBook(ResultSet resultSet) throws SQLException {
        ...
        book.setCreatedAt(resultSet.getTimestamp("createdAt").toLocalDateTime());
        return book;
    }
}
